...
public class ProductDao extends AbstractDao<Product, Void> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Prepared = new Property(8, Boolean.class, "prepared", false, "PREPARED");
        public final static Property Fk_category_id = new Property(9, long.class, "fk_category_id", false, "FK_CATEGORY_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'PRODUCT' (" + //
                ...
                "'PREPARED' INTEGER," + // 8: prepared
                "'FK_CATEGORY_ID' INTEGER NOT NULL );"); // 9: fk_category_id
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Product entity) {
        ...
        Boolean prepared = entity.getPrepared();
        if (prepared != null) {
            stmt.bindLong(9, prepared ? 1l: 0l);
        }
        stmt.bindLong(10, entity.getFk_category_id());
    }
    ...
    public Product readEntity(Cursor cursor, int offset) {
        Product entity = new Product( //
            ...
            cursor.isNull(offset + 8) ? null : cursor.getShort(offset + 8) != 0, // prepared
            cursor.getLong(offset + 9) // fk_category_id
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Product entity, int offset) {
        ...
        entity.setPrepared(cursor.isNull(offset + 8) ? null : cursor.getShort(offset + 8) != 0);
        entity.setFk_category_id(cursor.getLong(offset + 9));
     }
