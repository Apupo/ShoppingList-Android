...
public class Product {
    ...
    public Product(String title, String titleClean, String mainGroup, String subGroup, String comodity, String subComodity, java.util.Date modificationDate, Boolean inBasket, Boolean prepared, long fk_category_id) {
        this.title = title;
